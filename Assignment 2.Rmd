...
saveRDS(ca_pums_household, "ca_pums_household.rds")
```

```{r, echo=F}
ca_pums_household <-
readRDS("ca_pums_household.rds")
```
...
saveRDS(ca_pums_individual, "ca_pums_individual.rds")
```

```{r, echo=F}
ca_pums_individual <-
readRDS("ca_pums_individual.rds")
```
